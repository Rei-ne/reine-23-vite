...
const Footer = () => {
    return (
        <div className="bg-black flex flex-col lg:flex-row lg:justify-around lg:h-10 lg:border-t-2 lg:mt-10 border-gray w-full items-center justify-center uppercase h-14 p-8">
            <div>
