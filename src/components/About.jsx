...
function About() {
    return (
        <section id="about" className="h-fit md:h-fit about-div mt-10 flex flex-col justify-center items-center">
            ...
            <div className="max-h-1/4 w-4/5 text-gray-light md:flex flex-wrap md:flex-col lg:flex-row md:justify-around md:items-center md:h-4/5">
                ...
                <div className="right-about p-6 md:w-fit lg:w-1/3 text-sm leading-8 font-GT_Flexa">
                    ...
                    <p className="my-2">I am interested in web3, technical writing,  creative development, AnR and talent management.</p>
                    <p className="my-2">When I'm not coding, I'm listening to music or hanging out with my friends and listening to music with them 😀</p>
                </div>
