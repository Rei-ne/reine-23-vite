        ...
        <section id="about" className="h-full mt-10 flex flex-col justify-center items-center">
            ...
            <div className="max-h-1/4 w-4/5 text-gray-light md:flex flex-wrap md:flex-col lg:flex-row md:justify-around md:items-center md:h-4/5">
                <div className="font-GT_Flexa p-6 md:w-fit lg:w-1/3 text-sm max-w-prose leading-8 left-about">
                    ...
                    <p className="my-2">I say that because right now I’m an ex-banker, turned frontend web developer that is currently learning blockchain development.</p>
                ...
                <div className="right-about p-6 md:w-fit lg:w-1/3 text-sm leading-8 font-GT_Flexa">
                    ...
                    <p className="my-2">Music is another passion of mine, when I'm not coding, you can usually find me either listening to music on my <a href="https://open.spotify.com/user/31iptodfoldd453eq6tbmv4x6qlu?si=3c8bc7bf41b04de2" target="_blank">own</a> or enjoying it with my friends 😀</p>
                </div>
